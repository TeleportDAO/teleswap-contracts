...
describe("CcExchangeRouter", async () => {
    ...
    describe("#ccExchange", async () => {
        ...
        // TODO remove fixed token output from code
        ...
        it("Reverts if the request speed is not 0, (used for filler)", async function () {
            ...
            ).to.revertedWith("ExchangeRouter: filler is not supported");
        })
    ...
    describe("#Across", async () => {
        ...
        beforeEach(async () => {
            ...
            await ccExchangeRouter.supportToken(exchangeToken.address);
        });
        ...
        it("swap fails", async function () {
            // fail swap
            await ccExchangeRouter.removeToken(exchangeToken.address)
        ...
        it("can burn telebtc if swap failed", async function () {
            ...
            if (messageHex != null) {
                ...
                await expect(
                    await ccExchangeRouter.withdrawFailedCcExchange(
                        CC_EXCHANGE_REQUESTS.normalCCExchangeToOtherChain_fixedInput.txId,
                        USER_SCRIPT_P2PKH_TYPE,
                        USER_SCRIPT_P2PKH,
                        10,
        ...
        it("can't burn telebtc because of wrong sig", async function () {
            ...
            if (messageHex != null) {
                ...
                await expect(
                    ccExchangeRouter.withdrawFailedCcExchange(
                        CC_EXCHANGE_REQUESTS.normalCCExchangeToOtherChain_fixedInput.txId,
                        USER_SCRIPT_P2PKH_TYPE,
                        USER_SCRIPT_P2PKH,
                        10,
        ...
        it("can retry failed cc exchange if swap failed", async function () {
            ...
            if (messageHex != null) {
                ...
                rsv = await parseSignatureToRSV(signature) 
                await expect(
                    await ccExchangeRouter.retryFailedCcExchange(
                        CC_EXCHANGE_REQUESTS.normalCCExchangeToOtherChain_fixedInput.txId,
                        expectedOutputAmount,
                        10,
                        rsv.r,
        ...
        it("can't retry because of wrong sig", async function () {
            ...
            if (messageHex != null) {
                ...
                rsv = await parseSignatureToRSV(signature) 
                await expect(
                    ccExchangeRouter.retryFailedCcExchange(
                        CC_EXCHANGE_REQUESTS.normalCCExchangeToOtherChain_fixedInput.txId,
                        expectedOutputAmount,
                        10,
                        rsv.r,
    ...
    describe("#Third party", async () => {
        ...
        it("Third party gets its fee", async function () {
            ...
            .to.emit(ccExchangeRouter, 'CCExchange').withArgs(
                ...
                0,
                deployerAddress,
                [teleporterFee, protocolFee, thirdPartyFee],
